...
#'
#' This function computes multiple evaluation metrics based on a gram matrix and metadata:
#' including PCoA eigen decomposition, PERMANOVA, and MiRKAT-style pseudo R².
#'
#' @param G A gram matrix (numeric and symmetric).
...
#' @export
evaluate_beta_gram <- function(G, Y, Z, metadata, nperm = 999) {
